                                     ...
                                     <Grid item xs={12} sm={6} md={4} key={act._id}>
                                       <Card elevation={2} sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                                         <CardContent sx={{ flexGrow: 1 }}>
                                           ...
                                           {act.deadline && (
                                              <Box display="flex" justifyContent="space-between" mb={1}>
                                                <Typography color="error" variant="subtitle2">Deadline:</Typography>
                                                <Typography color="error" variant="body2">{new Date(act.deadline).toLocaleDateString()}</Typography>
                                              </Box>
                                           )}
                                         ...
                                         <CardActions sx={{ p: 2, pt: 0 }}>
                                           {mySubs?.some(sub => sub.activity_id?._id === act._id) ? (
